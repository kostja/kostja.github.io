...
set_single(s2['Text 39'], 'Замена PostgreSQL / Greengage')
...
set_single(s2['Text 15'],
    'Для нагрузок до 10–20 kRPS TCO PostgreSQL вне конкуренции. YDB начинает '
    'выигрывать, когда объём данных превышает несколько терабайт, требуется '
    'горизонтальное масштабирование и катастрофоустойчивость.')
set_single(s2['Text 26'],
    'Конкуренция с ClickHouse / Greengage / StarRocks требует значительного '
    'превосходства в скорости или общей стоимости владения.')
set_single(s2['Text 31'],
    'Аналитическая и транзакционная нагрузка требуют разной конфигурации '
    'кластеров. Средства multi-tenancy недостаточны.')
