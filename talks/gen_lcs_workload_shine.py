...
d.text("title", 20, 10, 1100, 28,
       "LCS сияет: OLTP с горячими ключами и предсказуемой p99",
       size=20, color=INK)
...
CASES = [
    ("OLTP-ядро (профили, сессии, корзины)",
     "много точечных чтений, ограниченное число горячих ключей"),
    ("Поиск по первичному ключу в API",
     "p99 — продуктовый SLA, latency-бюджет жёсткий"),
    ("Каталоги и справочники",
     "плотный набор ключей, обновления редкие"),
    ("Read-replica для аналитики",
     "сканы по диапазонам, мало пересечений между уровнями"),
]
